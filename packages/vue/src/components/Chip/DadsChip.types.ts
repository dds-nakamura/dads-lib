...
// DADS specifies three sizes for chip; the `xs` token used by some other
// components (e.g. DadsButton) is intentionally excluded to keep the visual
// weight aligned with form labels.
